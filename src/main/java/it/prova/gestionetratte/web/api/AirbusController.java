...
public class AirbusController {
	...
	public List<AirbusDTO> cercaAirbusEvidenziandoSovrapposizioni() {
		return airbusService.cercaAirbusConSovapposizioniDiTratte(airbusService.listAllElementsEager());
	}
